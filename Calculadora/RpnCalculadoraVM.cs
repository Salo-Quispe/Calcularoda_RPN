...
{
    public class RpnCalculadoraVM : INotifyPropertyChanged
    {
        string entry = "0";
        ...
        private Color buttonBackgroundColor = Color.Default;
        ...
        private Color buttonTextColor = Color.Default;
